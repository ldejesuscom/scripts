# Currently works only for Fi or Gi interfaces with format i.e. Fi1/0/1
list_of_interfaces = ['Fi1/0/1', 'Fi1/0/2','Fi1/0/3', 'Fi1/0/4', 'Fi1/0/5', 'Fi1/0/6', 'Fi1/0/8', 'Fi1/0/10', 'Fi1/0/11', 'Fi1/0/12', 'Fi1/0/13', 'Fi1/0/14', 'Fi1/0/15', 'Fi1/0/16', 'Fi1/0/17', 'Fi1/0/18', 'Fi1/0/19', 'Fi1/0/20', 'Fi2/0/1', 'Fi2/0/2', 'Fi2/0/24', 'Fi2/0/25', 'Fi2/0/26', 'Fi2/0/34', 'Fi2/0/35', 'Fi2/0/36', 'Fi2/0/37', 'Fi2/0/38', 'Fi3/0/1', 'Fi3/0/2', 'Fi3/0/3', 'Fi3/0/4', 'Fi3/0/5', 'Fi3/0/6', 'Fi3/0/10', 'Fi3/0/44', 'Fi3/0/46', 'Fi3/0/47', 'Fi3/0/48','Fi4/0/1','Fi4/0/2','Fi4/0/3','Fi4/0/4','Fi4/0/6','Fi4/0/8','Fi4/0/10','Fi4/0/11','Fi4/0/12','Fi5/0/2','Fi5/0/48']
vlan = input("What is the new voice VLAN number? ")

def change_voice_vlan(list_of_interfaces, vlan):
    ...
    config_script = """"""
    for index in range(len(list_of_int_range_commands)):
        if index != len(list_of_int_range_commands) -1:
            config_script += list_of_int_range_commands[index] + f"\nswitchport voice vlan {vlan}\n!\n"
        elif index == len(list_of_int_range_commands) -1:
            config_script += list_of_int_range_commands[index] + f"\nswitchport voice vlan {vlan}\n!\nend"
    print(config_script)

    # Write to txt file
    file = open("VoiceVLANConfig.txt", "w")
    file.write(config_script)
    file.close()
            

change_voice_vlan(list_of_interfaces, vlan)